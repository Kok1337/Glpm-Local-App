...
class BonitetSpinnerAdapter :
    SearchableSpinnerBindingAdapter<Bonitet, ItemSimpleViewBinding>(com.kok1337.searchable_spinner.R.layout.item_simple_view) {
    override fun setupView(binding: ItemSimpleViewBinding, item: Bonitet, position: Int) {

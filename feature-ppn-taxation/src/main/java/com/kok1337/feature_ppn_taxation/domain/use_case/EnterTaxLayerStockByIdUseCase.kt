...
internal class EnterTaxLayerStockByIdUseCase @Inject constructor(
    private val taxationTaxLayerInMemoryRepository: TaxationTaxLayerInMemoryRepository,
) {
    operator fun invoke(taxLayerId: UUID, stock: Double?) {
        taxationTaxLayerInMemoryRepository.updateStock(taxLayerId, stock)
    }
}
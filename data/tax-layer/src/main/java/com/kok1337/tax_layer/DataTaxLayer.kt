...
import com.kok1337.tax_layer.api.TaxLayerDependencies
import com.kok1337.tax_layer.api.TaxLayerRepositoryFactory
...
internal fun main(args: Array<String>) {
    ...
    val taxLayerDependencies = object : TaxLayerDependencies {
        override val jdbcTemplate: JdbcTemplate get() = jdbcTemplate
    }
    val taxLayerRepository = TaxLayerRepositoryFactory.create(taxLayerDependencies)

    println(taxLayerRepository)
}